...
- Cursor **granola-engineer** plugin (`plugins/granola-engineer/`) plus a
  `.cursor/` overlay: meeting-grounded agent, `/granola-engineer` command,
  Granola MCP, and fixture tests that keep the overlay in sync.
